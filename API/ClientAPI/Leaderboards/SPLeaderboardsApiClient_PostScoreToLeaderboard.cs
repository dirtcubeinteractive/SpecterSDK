...
namespace SpecterSDK.API.ClientAPI.Leaderboards
{
    ...
    public partial class SPLeaderboardsApiClient
    {
        ...
        /// the score is posted when you make the <see cref="SpecterSDK.API.ClientAPI.Matches.SPMatchesApiClient.EndMatchSessionAsync"/> call in the <see cref="SpecterSDK.API.ClientAPI.Matches.SPMatchesApiClient"/>
        /// </remarks>
        /// </summary>
